...
namespace EditorToolkit.ImGui
{
    ...
    public static class GizmoDrawer
    {
        ...
        public static void SetOrientationCubeTexture(nint user_texture_id)
        {
        ...
        {
            float distance = Vector2.Distance(center, ImGuiNET.ImGui.GetMousePos());
        ...
        public static bool RotationGizmo(in Matrix4x4 transformMatrix, float radius, out GizmoPart hoveredPart)
        {
            ...
            bool AxisGimbal(int axis)
            {
                ...
                bool isHovered = MathUtil.HitTestLineStripPoint(
                    ...
                    HOVER_LINE_THICKNESS, ImGuiNET.ImGui.GetMousePos());
