...
namespace EditorToolkit.Windowing;
...
public class ImGuiController : IDisposable
{
    ...
    private void OnKeyDown(IKeyboard keyboard, Key key, int scanCode)
    {
        ...
        if (TryMapKey(key, out ImGuiKey imguikey))
        {
            ImGuiNET.ImGui.GetIO().AddKeyEvent(imguikey, true);
        }
    }
    ...
    private void OnKeyUp(IKeyboard keyboard, Key key, int scanCode)
    {
        ...
        if (TryMapKey(key, out ImGuiKey imguikey))
        {
            ImGuiNET.ImGui.GetIO().AddKeyEvent(imguikey, false);
        }
    }
    ...
    private void UpdateImGuiInput()
    {
        ...
        ImGuiNET.ImGui.GetIO().AddKeyEvent(ImGuiKey.ModCtrl, ImGuiNET.ImGui.IsKeyDown(ImGuiKey.LeftCtrl) || ImGuiNET.ImGui.IsKeyDown(ImGuiKey.RightCtrl));
        ImGuiNET.ImGui.GetIO().AddKeyEvent(ImGuiKey.ModAlt, ImGuiNET.ImGui.IsKeyDown(ImGuiKey.LeftAlt) || ImGuiNET.ImGui.IsKeyDown(ImGuiKey.RightAlt));
        ImGuiNET.ImGui.GetIO().AddKeyEvent(ImGuiKey.ModShift, ImGuiNET.ImGui.IsKeyDown(ImGuiKey.LeftShift) || ImGuiNET.ImGui.IsKeyDown(ImGuiKey.RightShift));
        ImGuiNET.ImGui.GetIO().AddKeyEvent(ImGuiKey.ModSuper, ImGuiNET.ImGui.IsKeyDown(ImGuiKey.LeftSuper) || ImGuiNET.ImGui.IsKeyDown(ImGuiKey.RightSuper));
    }
    ...
    class Texture : IDisposable
    {
        ...
        public unsafe Texture(GL gl, int width, int height, nint data, bool generateMipmaps = false, bool srgb = false)
        {
            _gl = gl;
        ...
        public void SetAnisotropy(float level)
        {
            ...
            _gl.TexParameter(GLEnum.Texture2D, (GLEnum)textureMaxAnisotropy, Math.Clamp(level, 1, MaxAniso.GetValueOrDefault()));
        }
