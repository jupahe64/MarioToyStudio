...
{
    internal interface IPropertyCapture
    {
        bool HasChanges();
    ...
    internal abstract class PropertyCapture<T> : IPropertyCapture
    {
    ...
    internal class PropertyFieldsCapture : PropertyCapture<object?>
    {
        ...
        protected override IRevertable GetRevertable((string name, object oldValue)[] changedProperties, string name)
        {
            ...
            return new RevertablePropertyFieldsSet(mTarget, changedProperties, name);
        }
    ...
    internal class RevertablePropertyFieldsSet(object target, (string name, object oldValue)[] changedProperties,
        string name = "Change properties") : IRevertable
    {
        ...
        public IRevertable Revert()
        {
            ...
            return new RevertablePropertyFieldsSet(target, newChangedProperties);
        }
    }

    internal class PropertyDictCapture : PropertyCapture<PropertyDict?>
    {
        ...
        {
            Debug.Assert(mTarget != null);
            return new RevertablePropertyDictSet(mTarget, changedProperties, name);
        }
    ...
    internal class RevertablePropertyDictSet(PropertyDict target,
        (string name, object oldValue)[] changedProperties,
        string name = "Change properties") : IRevertable
    {
        public string Name => name;
        ...
        public IRevertable Revert()
        {
            ...
            return new RevertablePropertyDictSet(target, newChangedProperties);
        }
    }

    internal class FullPropertyCapture : IPropertyCapture
    {
