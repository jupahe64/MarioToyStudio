...
{
    internal class ErrorDialog : OkDialog
    {
        ...
        protected override void DrawBody()
        {
            ...
            ImGui.InputTextMultiline("##error message", ref message,
                (uint)message.Length, ImGui.GetContentRegionAvail(), ImGuiInputTextFlags.ReadOnly);
        }

        private static Vector2 CalcMinContentSize() => new(400, ImGui.GetFrameHeight() * 8);
