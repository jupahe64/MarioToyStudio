...
namespace ToyStudio.GLRendering
{
    public class BufferObject : GLObject, IDisposable
    {
        ...
        public unsafe void SetSubData<T>(T value, int offset) where T : unmanaged
        {
        ...
        public unsafe void SetStruct<T>(T[] data, int size, BufferUsageARB hint = BufferUsageARB.StaticDraw) where T : unmanaged
        {
            Bind();
